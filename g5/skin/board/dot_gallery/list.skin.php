...
<!-- thumbnail -->
<div class="col-sm-4">
<a data-toggle="modal" href="<?php echo $list[$i]['href'] ?>" class="thumbnail">
<?php
...
if($thumb['src']) {
    ...
    $img_content .= '<span style="text-align:center">'.$list[$i]['wr_subject'].'</span>';
} else {
         	...
         	<div class="news-list clearfix">
         				...
         				<div class="news-credit">
         					<ul class="list-inline">
         						...
         						<?php } ?>
         						<i class="glyphicon glyphicon-calendar"></i><?php echo $list[$i]['datetime2'] ?></li>
         				...
         				<div class="news-contents clearfix">
         					...
         					<button type="button" class="btn btn-success btn-xs btnRead" value="11" onclick="location.href='<?php echo $list[$i]['href'] ?>'">Read More</button> 
         				</div>
         			</div>	</div>-->
      <!--   			
