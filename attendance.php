...
<style>
  ...
  #cont2{position: relative;width:50%;height:100%;background: #f2f;float: left;}
...
<h2>서울 에스라 교회 출석인원<input type="button" value="합체" onclick="merge('t')"><input type="button" value="분리" onclick="merge('f')"></h2>
...
<style type="text/css">
  ...
  .att tr:nth-child(2n){background:#ff8c00;color:white}
</style>
 </body>
</html>
