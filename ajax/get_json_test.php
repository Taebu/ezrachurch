...
$sql = ''; 
$sql="select * from g4_board_new where 1=1 ";

if($type=="comment"){
$sql .= " and wr_id<>wr_parent   and bo_list_level<5 order by bn_datetime desc limit $firstNum,$listsize"; 
}else{
$sql .= " and wr_id=wr_parent  and bo_list_level<5 order by bn_datetime desc  limit $firstNum,$listsize"; 
}
...
$result=mysql_query("SELECT * FROM g4_write_{$rss[bo_table]} where wr_id='{$rss[wr_id]}';");
