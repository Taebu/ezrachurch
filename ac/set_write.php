...
$size="1280";
if(!empty($_FILES['ab_image_file'])&&$_FILES['ab_image_file']['error']!="4")
{
	// 설정
	$uploads_dir = '/uploads';
...
$TABLES=array_diff_key($TABLES, array('table' => "","ab_image_file"=>""));
...
if(isset($_FILES['ab_image_file'])&&$_FILES['ab_image_file']['error']!="4")
{
