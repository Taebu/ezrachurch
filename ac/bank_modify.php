...
if($is_multiple)
{
	...
	$key = array_search($ab_class, array_column($account_users, 'ab_class'));
	$executive=$account_users[$key];
}
?>
...
echo sprintf("<input type='hidden' name='au_no' id='au_no' value='%s'>",$executive['au_no']);
