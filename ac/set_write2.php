...
$TABLES=array_diff_key($TABLES, array('table' => "","ab_image_file"=>"","page_start_size"=>"","bf_date"=>""));
...
if (!empty($_FILES['file'])) 
{
	...
	*
	*******************/
	$file_upload_url="/upload/".sprintf('%s/%s/%s_%s', $ab_class, $YMD,$ab_no,$i);
