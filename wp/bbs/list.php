...
if($config['cf_theme']=="modificate"){
//	echo "total_page : ".$total_page.", page".$page;
$write_pages = get_modi_paging($config['cf_write_pages'], $page, $total_page, './board.php?bo_table='.$bo_table.$qstr.'&amp;page=');
