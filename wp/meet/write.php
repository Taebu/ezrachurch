...
if($em_no)
{
$sql="select * from ez_meet  where em_no={$em_no} order by em_no desc;";
$query=sql_query($sql);
$row=sql_fetch_array($query);
}
?>
<link id="bsdp-css" href="<?php echo G5_THEME_URL;?>/plugin/bootstrap-datepicker/css/bootstrap-datepicker3.css" rel="stylesheet">
		...
		<section>
          ...
          <div data-autoplay="5000" data-slide-effect="fade" data-loop="false" class="swiper-container swiper-slider" style="color:#fff">
            ...
            <div class="swiper-wrapper">
              <div data-slide-bg="<?php echo G5_THEME_URL;?>/images/wpmqwrjwpls-alberto-restifo.jpg" class="swiper-slide">
        ...
        <section class="text-center text-sm-left well well-sm">
		  ...
		  <div id="sandbox-container">
            <div class="row">
				...
				<input type="hidden" name="mode" value="write" />
				 <div class="col-xs-12">
                    <div class="form-group">
                      <label for="reg_mb_id" class="text-uppercase font-secondary">회차<strong class="sound_only">필수</strong> * </label>
                ...
                <input type="button" value="<?php echo $w==''?'강좌등록':'강좌수정'; ?>" id="btn_submit" class="btn btn-primary btn-xs round-small btn_submit" accesskey="s" onclick="javascript:set_meet();">
