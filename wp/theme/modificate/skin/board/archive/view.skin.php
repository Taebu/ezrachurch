...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <!-- 게시물 상단 버튼 시작 { -->
    <div id="bo_v_top"><?php $exp_k=explode("=",$view['wr_link1']);?>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $exp_k[1];?>" frameborder="0" allowfullscreen></iframe>
        <?php
        ob_start();
         ?>
