...
?>
                ...
                <table class="table">
                  ...
                  <tbody class="text-darker-clr">
                    <tr class="section-border-white">
                      <td class="bg-lighter-2">Returning customer? <a href="#" class="text-primary">Click here to login</a></td>
                      <td class="bg-lighter-2"></td>
                    </tr>
                    <tr class="section-border-white">
                      <td class="bg-lighter-2">Have a coupon? <a href="#" class="text-primary">Click here to enter your code</a></td>
                      <td class="bg-lighter-2"></td>
                    </tr>
                  </tbody>
                </table>
    ...
    <input type="hidden" name="page" value="<?php echo $page ?>">
		...
		<?php if ($is_name) { ?>
		  <div class="col-xs-12">
			<div class="form-group">
			  ...
			  <input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" class="form-control round-small" size="10" maxlength="20">
			</div>
		  </div>
		<?php } ?>
        ...
        <?php if ($is_password) { ?>
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_password">비밀번호<strong class="sound_only">필수</strong></label>
            <input type="password" name="wr_password" id="wr_password" <?php echo $password_required ?> class="form-control round-small <?php echo $password_required ?>" maxlength="20">			</div>
		  </div>
        ...
        <?php if ($is_email) { ?>
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_email">이메일</label>
            <input type="text" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="form-control round-small email" size="50" maxlength="100"></div>
        </div>
        <?php } ?>

        <?php if ($is_homepage) { ?>
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_homepage">홈페이지</label>
            <input type="text" name="wr_homepage" value="<?php echo $homepage ?>" id="wr_homepage" class="form-control round-small" size="50"></div>
        </div>
        <?php } ?>
        ...
        <?php if ($is_category) { ?>
		  <div class="col-xs-12">
			<div class="form-group"><label for="ca_name">분류<strong class="sound_only">필수</strong></label>
        ...
        <?php } ?>
		  ...
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_subject">제목<strong class="sound_only">필수</strong></label>
            
                <div id="autosave_wrapper">
                    <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control round-small required" size="50" maxlength="255">
		  ...
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_content">내용<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
        ...
        <?php for ($i=1; $is_link && $i<=G5_LINK_COUNT; $i++) { ?>
		  <div class="col-xs-12">
			<div class="form-group"><label for="wr_link<?php echo $i ?>">링크 #<?php echo $i ?></label>
            <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="form-control round-small" size="50"></div>
        </div>
        <?php } ?>

        <?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
		  <div class="col-xs-12">
			<div class="form-group">파일 #<?php echo $i+1 ?>
