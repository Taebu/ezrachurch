...
<article id="bo_v" style="width:<?php echo $width; ?>">
 ...
 <?php
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con">
        <!-- 2017-04-15 youtube link add -->
        <?php    
        if ($view['link']) {
            $is_youtube_uri=false;
            $is_youtube_uri=preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $view['link'][1], $match);

            if($is_youtube_uri)
            {
                ?>
                <div class="video-container">
                <iframe frameborder="0" width="853" height="480" src="https://www.youtube.com/embed/<?php echo $match[1];?>?autoplay=0&amp;controls=1&amp;loop=1&amp;rel=1&amp;showinfo=1&amp;autohide=1&amp;start=5" allowfullscreen=""></iframe></div><!-- .video-container -->
                <?php
