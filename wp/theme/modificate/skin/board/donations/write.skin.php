...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_1">목표금액(wr_1)</label></th>
            <td><input type="number" name="wr_1" value="<?php if($w=="u"){echo$write['wr_1'];} ?>" id="wr_1" placeholder="목표 금액을 입력하세요 예) 100만원 -> 1000000"  class="form-control round-small" style=width:100% maxlength="255"></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_2">목표일(wr_2)</label></th>
            <td><input type="date" name="wr_2" value="<?php if($w=="u"){echo$write['wr_2'];} ?>" id="wr_2" placeholder="목표일을 입력하세요 예) 2018년 8월 22일 -> 2018-08-22"  class="form-control round-small" style=width:100% maxlength="255"></td>
        </tr>
