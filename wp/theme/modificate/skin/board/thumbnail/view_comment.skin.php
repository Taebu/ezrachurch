...
var char_max = parseInt(<?php echo $comment_max ?>); // 최대
    ...
    <!--</article>-->
                  ...
                  <div class="col-xs-12<?php if($i>0){?> inset-1<?php }?><?php if ($cmt_depth) { ?> text-right<?php }?>">
                    <blockquote class="box-sm <?php if ($cmt_depth) { ?>back-comment<?php } ?>">
                      ...
                      <div class="box__body box__middle btn-shadow round-small">
                        <h6><?php echo get_text($list[$i]['wr_name']);?></h6>
                        <time datetime="2015" class="meta"><?php echo $list[$i]['datetime'] ?></time>
                        <p class="big text-light-clr"><?php if (strstr($list[$i]['wr_option'], "secret")) { ?><img src="<?php echo $board_skin_url; ?>/img/icon_secret.gif" alt="비밀글"><?php } ?>
						<?php echo $comment ?></p>
                      </div>
                    </blockquote>
                  </div>
