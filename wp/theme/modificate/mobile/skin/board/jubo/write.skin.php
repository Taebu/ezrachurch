...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_content">주보겉표지 *
<table>
    <tr>
        <td>주보2면</td>
        <td>주보1면</td>
...
<tr>
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_1">주보 1면*
<style>
    .highlight{
...
<table>
    ...
    <tr>
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_2">주보2면 
<table>
    <tr>
    ...
    <tr>
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_3">주보3면
<table>
    <tr>
        <td>주보2면</td>
        <td>주보1면</td>
    ...
    <tr>
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_4">주보4면<table>
    <tr>
        <td>주보2면</td>
        <td>주보1면</td>
        <td>주보겉표지</td>
    ...
    <tr>
        ...
        <tr>
            <th scope="row" colspan="2"><label for="wr_5">주보5면<table>
    <tr>
        <td>주보2면</td>
        <td>주보1면</td>
        <td>주보겉표지</td>
