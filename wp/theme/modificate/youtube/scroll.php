...
//    alert(q+"은 준비 중 입니다.");
	...
	for(var i in ez_youtube_wm){
		...
		if(ez_youtube_wm[i].ey_title.indexOf(q)>-1)
		{
			console.log();
...
<a id="book_39" href="javascript:get_youtube('마태');" class="list-group-item">마태</a>
<a id="book_40" href="javascript:get_youtube('마가');" class="list-group-item">마가</a>
<a id="book_41" href="javascript:get_youtube('누가');" class="list-group-item">누가</a>
<a id="book_42" href="javascript:get_youtube('요한');" class="list-group-item">요한</a>
