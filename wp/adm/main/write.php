...
<div id="youtube_main_list">
  <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
				...
				<tr>
            <th scope="row"><label for="cf_title">유튜브 링크<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">
						<input type="text" name="ym_link" id="ym_link" value=""  class="required frm_input" size="40" onchange="javascript:get_thumb(this.value);" onkeyup="javascript:get_thumb(this.value);" onkeydown="javascript:get_thumb(this.value);"></td>
        </tr>
				<tr>

						<th scope="row"><label for="cf_title">유튜브 썸네일</label></th>
						<td colspan="3"><span id="youtube_thumbnail"></span>		</td>    </tr>
				<tr>
            <th scope="row"><label for="cf_title">유튜브 가운데 텍스트<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">
						<textarea name="ym_content"  id="ym_content"  cols="10" rows="5"></textarea></td>
        </tr>

				<tr>
            <th scope="row"><label for="cf_title">유튜브 시작 타임 (단위 초)<strong class="sound_only">필수</strong></label></th>
            <td colspan="3">
						<input type="text" name="ym_time" id="ym_time" value=""></td>
        </tr>

				</tbody>
        </table>
<div class="btn_confirm01 btn_confirm">
<a href='javascript:set_youtubemain("write");'>쓰기</a>
<!-- 		<input type="submit" value="확인" class="btn_submit" accesskey="s"> -->
<a href="javascript:location.href='./list.php';">list</a>

</div>
    </div>
</div><!-- #youtube_main_list -->
<?if($isadmin){?>
<ul id="check"></ul>
<?}else{
...
function set_youtubemain(mode)
{
	var param={};
	param.ym_link=$("#ym_link").val();
	param.ym_content=$("#ym_content").val();
	param.ym_time=$("#ym_time").val();
	param.mode=mode;
...
function get_thumb(v)
{
if(v.length>10)
{
var object=[];
//$("#youtube_thumbnail").attr("src","https://img.youtube.com/vi/"+v+"/default.jpg");
				object.push("<img src='https://img.youtube.com/vi/"+v+"/default.jpg'>");
				object.push("<img src='https://img.youtube.com/vi/"+v+"/1.jpg'>");
				object.push("<img src='https://img.youtube.com/vi/"+v+"/2.jpg'>");
				object.push("<img src='https://img.youtube.com/vi/"+v+"/3.jpg'>");
$("#youtube_thumbnail").html(object.join(""));
}
}
</script>
<?php
