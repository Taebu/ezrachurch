...
<header id="hd">
    <div id="hd_wrap">
        ...
        <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo.jpg" alt="<?php echo $config['cf_title'] ?> 관리자"></a>
		<a href=<?php echo G5_URL ?>/index.php><font color=white>홈페이지 가기</font></a>
		</div>
