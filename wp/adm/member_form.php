...
this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
    ...
    <?php 
	$member_option=array("","1: 국가(I:국내,O:국외)","2: 거주국가","3: 에스라집회 참가횟수","4: 출석교회","5: 소속교단","6: 직분","7: 신앙년수","여분필드 8","9: 성서원 구분","10: 교회구분");
	for ($i=1; $i<=10; $i++) { ?>
    <tr>
        <th scope="row"><label for="mb_<?php echo $i ?>"><?php echo $member_option[$i]; ?></label></th>
