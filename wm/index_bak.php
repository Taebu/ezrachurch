...
if(isset($_GET['big_hebrew']))
{
$is_big_hebrew=$_GET['big_hebrew']=="on";
$checkbox_big_hebrew=$is_big_hebrew?"checked":"";
}
...
<input type="checkbox" name="big_hebrew" id="big_hebrew" <?php echo $checkbox_big_hebrew;?>>
<label for="big_hebrew">빅히브리어 병행</label>
<br>
